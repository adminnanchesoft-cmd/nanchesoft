...
public sealed class HumanResourcesApiService
{
    ...
    private async Task<CatalogViewDefinition> GetPayrollConceptsAsync()
    {
        ...
        return BuildView(
            ...
            [
                ...
                TextColumn("SatTipoPercepcionCode", "TipoPercepcion SAT", width: 120),
                TextColumn("SatTipoDeduccionCode", "TipoDeduccion SAT", width: 120),
                TextColumn("SatTipoOtroPagoCode", "TipoOtroPago SAT", width: 120),
                ...
                TextColumn("Formula", "Fórmula importe", width: 240),
                TextColumn("TaxableFormula", "Fórmula gravado ISR", width: 240),
                TextColumn("ExemptFormula", "Fórmula exento ISR", width: 240),
                TextColumn("ImssTaxableFormula", "Fórmula gravado IMSS", width: 240),
                BoolColumn("IsRecurring", "Recurrente", width: 100),
                BoolColumn("IsAutomatic", "Auto", width: 80),
                BoolColumn("AutomaticOnGlobalRun", "Auto Global", width: 110),
                BoolColumn("AutomaticOnTermination", "Auto Liquidación", width: 130),
                BoolColumn("IsInKind", "Especie", width: 90),
                BoolColumn("PrintOnReceipt", "Imprime", width: 90),
                BoolColumn("RequiresSatStamping", "Timbra", width: 90),
                BoolColumn("AffectsImss", "Afecta IMSS", width: 110),
                BoolColumn("AffectsIsr", "Afecta ISR", width: 100),
                BoolColumn("AffectsSeventhDay", "Afecta 7° día", width: 110),
                BoolColumn("AffectsHolidayPay", "Afecta vacaciones", width: 130),
                BoolColumn("AffectsAccumulators", "Acumula", width: 100),
                NumberColumn("MinAmount", "Mínimo", width: 100),
                NumberColumn("MaxAmount", "Máximo", width: 100),
    ...
    private static PayrollConceptRequest MapPayrollConceptRequest(JsonElement payload) => new()
    {
        ...
        SatTipoPercepcionCode = ReadString(payload, "SatTipoPercepcionCode"),
        SatTipoDeduccionCode = ReadString(payload, "SatTipoDeduccionCode"),
        SatTipoOtroPagoCode = ReadString(payload, "SatTipoOtroPagoCode"),
        ...
        AutomaticOnGlobalRun = ReadBool(payload, "AutomaticOnGlobalRun"),
        AutomaticOnTermination = ReadBool(payload, "AutomaticOnTermination"),
        IsInKind = ReadBool(payload, "IsInKind"),
        AffectsSeventhDay = ReadBool(payload, "AffectsSeventhDay"),
        AffectsHolidayPay = ReadBool(payload, "AffectsHolidayPay"),
        AffectsImss = ReadBool(payload, "AffectsImss", true),
        AffectsIsr = ReadBool(payload, "AffectsIsr", true),
        AffectsAccumulators = ReadBool(payload, "AffectsAccumulators", true),
        RequiresSatStamping = ReadBool(payload, "RequiresSatStamping", true),
        ...
        MinAmount = ReadDecimal(payload, "MinAmount"),
        MaxAmount = ReadDecimal(payload, "MaxAmount"),
        Formula = ReadString(payload, "Formula"),
        TaxableFormula = ReadString(payload, "TaxableFormula"),
        ExemptFormula = ReadString(payload, "ExemptFormula"),
        ImssTaxableFormula = ReadString(payload, "ImssTaxableFormula"),
