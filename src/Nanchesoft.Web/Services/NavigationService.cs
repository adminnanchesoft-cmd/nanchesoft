...
public sealed class NavigationService
{
    ...
    public List<NavigationMenuGroup> GetMenu()
    {
        var menu = new List<NavigationMenuGroup>
        {
            ...
            new() { Title = "Tesorería", Items = [ new NavigationMenuItem { Title = "Cajas", Route = "/treasury/cash-accounts" }, new NavigationMenuItem { Title = "Bancos propios", Route = "/treasury/bank-accounts" }, new NavigationMenuItem { Title = "Movimientos bancarios", Route = "/finance/bank-movements" }, new NavigationMenuItem { Title = "Transferencias internas", Route = "/finance/bank-transfers" }, new NavigationMenuItem { Title = "Estados de cuenta", Route = "/finance/bank-statements" }, new NavigationMenuItem { Title = "Conciliación asistida", Route = "/finance/reconciliation-suggestions" }, new NavigationMenuItem { Title = "Ingresos", Route = "/treasury/incomes" }, new NavigationMenuItem { Title = "Egresos", Route = "/treasury/expenses" }, new NavigationMenuItem { Title = "Recibos", Route = "/treasury/receipts" }, new NavigationMenuItem { Title = "Pagos", Route = "/treasury/payments" }, new NavigationMenuItem { Title = "Conciliaciones", Route = "/treasury/reconciliations" }, new NavigationMenuItem { Title = "Dashboard tesorería", Route = "/treasury/dashboard" } ] },
