...
public sealed class NavigationService
{
    ...
    public List<NavigationMenuGroup> GetMenu()
    {
        ...
        {
            new() { Title = "Inicio", Items = [ new NavigationMenuItem { Title = "Dashboard", Route = "/dashboard" }, new NavigationMenuItem { Title = "Perfil", Route = "/profile" }, new NavigationMenuItem { Title = "Apariencia", Route = "/settings/appearance" } ] },
            ...
            new() { Title = "Producción", Items = [
                ...
                new NavigationMenuItem { Title = "Pedidos de producción", Route = "/produccion/pedidos", Badge = "NUEVO" },
            ...
            new() { Title = "Tesorería", Items = [ new NavigationMenuItem { Title = "Cajas", Route = "/treasury/cash-accounts" }, new NavigationMenuItem { Title = "Bancos propios", Route = "/treasury/bank-accounts" }, new NavigationMenuItem { Title = "Ingresos", Route = "/treasury/incomes" }, new NavigationMenuItem { Title = "Egresos", Route = "/treasury/expenses" }, new NavigationMenuItem { Title = "Recibos", Route = "/treasury/receipts" }, new NavigationMenuItem { Title = "Pagos", Route = "/treasury/payments" }, new NavigationMenuItem { Title = "Dashboard tesorería", Route = "/treasury/dashboard" } ] },
            new() { Title = "Bancos", Items = [
                new NavigationMenuItem { Title = "Catálogo de bancos", Route = "/catalogs/banks" },
                new NavigationMenuItem { Title = "Cuentas bancarias", Route = "/treasury/bank-accounts" },
                new NavigationMenuItem { Title = "Movimientos bancarios", Route = "/finance/bank-movements" },
                new NavigationMenuItem { Title = "Transferencias", Route = "/finance/bank-transfers" },
                new NavigationMenuItem { Title = "Estado de cuenta", Route = "/finance/bank-statements" },
                new NavigationMenuItem { Title = "Conciliación bancaria", Route = "/finance/reconciliation-suggestions" },
                new NavigationMenuItem { Title = "Conciliaciones clásicas", Route = "/treasury/reconciliations" },
                new NavigationMenuItem { Title = "Chequeras", Route = "/finance/check-books", Badge = "NUEVO" },
                new NavigationMenuItem { Title = "Cheques", Route = "/finance/checks", Badge = "NUEVO" },
                new NavigationMenuItem { Title = "Tipos de movimiento", Route = "/finance/movement-types", Badge = "NUEVO" },
                new NavigationMenuItem { Title = "Conceptos financieros", Route = "/finance/concepts", Badge = "NUEVO" }
            ] },
            ...
            new() { Title = "CxP", Items = [ new NavigationMenuItem { Title = "Dashboard cuentas por pagar", Route = "/accounts-payable/dashboard" }, new NavigationMenuItem { Title = "Central de pagos", Route = "/finance/payment-central", Badge = "NUEVO" }, new NavigationMenuItem { Title = "Lotes de pre-pago", Route = "/finance/payment-batches", Badge = "NUEVO" }, new NavigationMenuItem { Title = "Pantalla ejecutiva pagos", Route = "/finance/payment-executive", Badge = "NUEVO" }, new NavigationMenuItem { Title = "Saldos por proveedor", Route = "/accounts-payable/balances" }, new NavigationMenuItem { Title = "Estado de cuenta", Route = "/accounts-payable/statements" }, new NavigationMenuItem { Title = "Antigüedad de saldos", Route = "/accounts-payable/aging" }, new NavigationMenuItem { Title = "Aplicaciones de pagos", Route = "/accounts-payable/applications" } ] },
            ...
            new() { Title = "Administración", Items = [ new NavigationMenuItem { Title = "Importación universal", Route = "/administration/universal-import", Badge = "CSV" }, new NavigationMenuItem { Title = "Sesiones", Route = "/administration/sessions", Badge = "RO" }, new NavigationMenuItem { Title = "Bitácora", Route = "/administration/access-logs", Badge = "RO" }, new NavigationMenuItem { Title = "Series documentales", Route = "/administration/document-series" }, new NavigationMenuItem { Title = "Folios documentales", Route = "/administration/document-folios" }, new NavigationMenuItem { Title = "Configuración empresa", Route = "/administration/company-settings" }, new NavigationMenuItem { Title = "Impresión compras", Route = "/purchases/print-center" } ] }
        };
