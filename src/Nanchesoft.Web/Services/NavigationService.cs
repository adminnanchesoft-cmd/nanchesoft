...
public sealed class NavigationService
{
    ...
    public List<NavigationMenuGroup> GetMenu()
    {
        var menu = new List<NavigationMenuGroup>
        {
            ...
            new() { Title = "Recursos Humanos", Items = [ new NavigationMenuItem { Title = "Departamentos", Route = "/human-resources/departments" }, new NavigationMenuItem { Title = "Puestos", Route = "/human-resources/positions" }, new NavigationMenuItem { Title = "Colaboradores", Route = "/human-resources/employees" }, new NavigationMenuItem { Title = "Incidencias", Route = "/human-resources/incidents" }, new NavigationMenuItem { Title = "Turnos", Route = "/human-resources/shifts", Badge = "NEW" }, new NavigationMenuItem { Title = "Horarios laborales", Route = "/human-resources/work-schedules", Badge = "NEW" }, new NavigationMenuItem { Title = "Tipos de ausencia", Route = "/human-resources/leave-types", Badge = "NEW" }, new NavigationMenuItem { Title = "Vacaciones y permisos", Route = "/human-resources/vacation-requests", Badge = "FLOW" }, new NavigationMenuItem { Title = "Reloj checador", Route = "/human-resources/time-clock", Badge = "AUTO" }, new NavigationMenuItem { Title = "Resumen asistencia", Route = "/human-resources/attendance-daily-summaries", Badge = "AUTO" }, new NavigationMenuItem { Title = "Dispositivos reloj", Route = "/human-resources/time-clock-devices", Badge = "IOT" }, new NavigationMenuItem { Title = "Documentos empleados", Route = "/human-resources/employee-documents", Badge = "DOC" }, new NavigationMenuItem { Title = "Movimientos laborales", Route = "/human-resources/employee-movements", Badge = "FLOW" }, new NavigationMenuItem { Title = "Certificaciones", Route = "/human-resources/employee-certifications", Badge = "TRAIN" }, new NavigationMenuItem { Title = "Vacantes", Route = "/human-resources/recruitment-vacancies", Badge = "TALENT" }, new NavigationMenuItem { Title = "Candidatos", Route = "/human-resources/candidate-applications", Badge = "PIPE" }, new NavigationMenuItem { Title = "Onboarding", Route = "/human-resources/onboarding-checklists", Badge = "FLOW" }, new NavigationMenuItem { Title = "Desempeño", Route = "/human-resources/performance-reviews", Badge = "PERF" }, new NavigationMenuItem { Title = "Competencias", Route = "/human-resources/competency-assessments", Badge = "MATRIX" }, new NavigationMenuItem { Title = "Sucesión", Route = "/human-resources/succession-plans", Badge = "9BOX" } ] },
            new() { Title = "Contratos", Items = [ new NavigationMenuItem { Title = "Contratos laborales", Route = "/contracts/employee-contracts" } ] },
            new() { Title = "Nómina", Items = [ new NavigationMenuItem { Title = "Periodos", Route = "/payroll/periods" }, new NavigationMenuItem { Title = "Conceptos", Route = "/payroll/concepts" }, new NavigationMenuItem { Title = "Procesamientos", Route = "/payroll/runs" }, new NavigationMenuItem { Title = "Detalle nómina", Route = "/payroll/run-lines" }, new NavigationMenuItem { Title = "Percepciones y deducciones", Route = "/payroll/run-line-details", Badge = "CFDI" }, new NavigationMenuItem { Title = "Aplicaciones calculadas", Route = "/payroll/source-applications", Badge = "TRACE" }, new NavigationMenuItem { Title = "Control de recibos", Route = "/payroll/receipt-control", Badge = "NEW" }, new NavigationMenuItem { Title = "Cierres de nómina", Route = "/payroll/run-closings", Badge = "FLOW" }, new NavigationMenuItem { Title = "Dispersiones bancarias", Route = "/payroll/dispersion-batches", Badge = "BANK" }, new NavigationMenuItem { Title = "Líneas de dispersión", Route = "/payroll/dispersion-lines", Badge = "BANK" }, new NavigationMenuItem { Title = "Pólizas nómina", Route = "/payroll/accounting-postings", Badge = "GL" }, new NavigationMenuItem { Title = "Acumulados fiscales", Route = "/payroll/tax-accumulators", Badge = "FISC" }, new NavigationMenuItem { Title = "Obligaciones patronales", Route = "/payroll/employer-obligations", Badge = "LEGAL" }, new NavigationMenuItem { Title = "Conciliación fiscal", Route = "/payroll/fiscal-reconciliations", Badge = "SAT" }, new NavigationMenuItem { Title = "Movimientos periódicos", Route = "/payroll/recurring-movements", Badge = "AUTO" }, new NavigationMenuItem { Title = "Ajustes prenómina", Route = "/payroll/prepayroll-adjustments", Badge = "NEW" }, new NavigationMenuItem { Title = "Cortes prenómina", Route = "/payroll/prepayroll-cutoffs", Badge = "FLOW" }, new NavigationMenuItem { Title = "Préstamos", Route = "/payroll/loans", Badge = "AUTO" }, new NavigationMenuItem { Title = "Descuentos préstamos", Route = "/payroll/loan-deductions" }, new NavigationMenuItem { Title = "Recibos de nómina", Route = "/payroll/receipts" }, new NavigationMenuItem { Title = "Impresión nómina", Route = "/payroll/print-center" } ] },
