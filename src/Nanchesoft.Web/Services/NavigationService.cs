...
public sealed class NavigationService
{
    ...
    public List<NavigationMenuGroup> GetMenu()
    {
        var menu = new List<NavigationMenuGroup>
        {
            ...
            new() { Title = "Nanchesoft IA", Items = [ new NavigationMenuItem { Title = "Asistente Nóminas y RH", Route = "/ia/chat", Badge = "IA" } ] },
            ...
            new() { Title = "Integración SilvaSoft", Items = [
                new NavigationMenuItem { Title = "Configuración conexión", Route = "/integration/silvasoft/config", Badge = "SS" },
                new NavigationMenuItem { Title = "Familias de producto", Route = "/integration/silvasoft/familias", Badge = "SS" },
                new NavigationMenuItem { Title = "Importar composición", Route = "/integration/silvasoft/composicion", Badge = "SS" },
                new NavigationMenuItem { Title = "Logs de sincronización", Route = "/integration/silvasoft/logs", Badge = "LOG" }
            ] }
        };
