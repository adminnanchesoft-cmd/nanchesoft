...
public sealed class CatalogCrudDispatcher
{
    ...
    public Task<CatalogViewDefinition> GetDefinitionAsync(string catalogKey)
    {
        ...
        return normalized switch
        {
            ...
            "unit-conversions" or "size-runs" or "families" or "lasts" or "lines" or "styles" or "embroidery-patterns" or "item-engineering-profiles" or "process-vouchers" or "material-families" or "material-subfamilies" or "material-items" or "material-suppliers" or "material-supplier-cost-history" or "finished-products" or "product-components" or "finished-product-materials" or "product-consumption-profiles" or "colors" or "manufacturing-types" or "toe-caps" or "dies" or "leather-types" or "soles" or "sole-colors" or "quality-control-dies" or "folio-patterns" or "production-phases" or "material-characteristics" or "material-sizes"
